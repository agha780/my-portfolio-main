            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">
                  alaghaahmed1998@gmail.com
                </span>
                <a
                  href="mailto:alaghaahmed1998@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">+966509135854</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=+966509135854&text=Hello"
                    target="_blank"
                    className="contact__button"
                    rel="noreferrer"
                  >
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Ahmed Alagha</span>
                  <a
                    href="https://m.me/agha780/"
                    className="contact__button"
                    target="_blank"
                    rel="noreferrer"
                  >
            ...
            <form className="contact__form" ref={form} onSubmit={sendEmail}>
              ...
              <div className="contact__form-div">
                ...
                <input
                  required
                  type="email"
                  name="email" // name is important because when i do the templennt in emailjs i need to use the same tag which name to get the sender name
                  className="contact__form-input"
